...
def main():
    """If the json file doesn't exist, it will create the car_park object with this configuration and then
    write it to json. Else, it will create the car_park via the config file."""
